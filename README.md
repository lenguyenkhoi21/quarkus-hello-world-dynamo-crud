# quarkus-hello-world-dynamo-crud Project
...
You can then execute your native executable with: `./build/quarkus-hello-world-dynamo-crud-1.0-SNAPSHOT-runner`
...
- Amazon DynamoDB
  Enhanced ([guide](https://quarkiverse.github.io/quarkiverse-docs/quarkus-amazon-services/dev/amazon-dynamodb.html)):
